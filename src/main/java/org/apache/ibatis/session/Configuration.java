...
public class Configuration {
    ...
    // 允许 JDBC 支持自动生成主键，需要驱动兼容。这就是insert时获取mysql自增主键/oracle sequence的开关。默认为false。
    ...
    /**
     * 维护了一个静态内部类StrictMap继承HashMap
     * 重写了put和get方法
     * 对HashMap的装饰在于增加了put时防重复的处理，get时取不到值时候的异常处理，这样核心应用层就不需要额外关心各种对象异常处理,简化应用层逻辑。
     *
     * @param <V>
     */
